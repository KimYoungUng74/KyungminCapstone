...
<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
    ...
    <link rel="stylesheet" href="<c:url value='resources/shop/css/bootstrap.min.css'/>">
    ...
    <!-- Modernizr JS -->
    <script src="<c:url value='resources/shop/js/vendor/modernizr-3.5.0.min.js'/>"></script>
</head>
...
<body>
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.html"><img src="<c:url value='resources/shop/images/logo/4.png'/>" alt="logo images"></a>
                                </div>
                            </div>
                    ...
                    <div class="shp__cart__wrap">
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                                <a href="#">
                                    <img src="<c:url value='resources/shop/images/product-2/sm-smg/1.jpg'/>" alt="product images">
                                </a>
                            </div>
                        ...
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                                <a href="#">
                                    <img src="<c:url value='resources/shop/images/product-2/sm-smg/2.jpg'/>" alt="product images">
                                </a>
                            </div>
                            <div class="shp__pro__details">
                ...
                <div class="single__slide animation__style01 slider__fixed--height">
                    <div class="container">
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="<c:url value='resources/shop/images/slider/fornt-img/2.png'/>" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="product__list clearfix mt--30">
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product-details.html">
                                            <img src="<c:url value='resources/shop/images/product/2.jpg'/>" alt="product images">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
                                        <ul class="product__action">
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product-details.html">
                                            <img src="<c:url value='resources/shop/images/product/3.jpg'/>" alt="product images">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
                                        <ul class="product__action">
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product-details.html">
                                            <img src="<c:url value='resources/shop/images/product/4.jpg'/>" alt="product images">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
                                        <ul class="product__action">
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product-details.html">
                                            <img src="<c:url value='resources/shop/images/product/5.jpg'/>" alt="product images">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
                                        <ul class="product__action">
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product-details.html">
                                            <img src="<c:url value='resources/shop/images/product/6.jpg'/>" alt="product images">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
                                        <ul class="product__action">
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product-details.html">
                                            <img src="<c:url value='resources/shop/images/product/7.jpg'/>" alt="product images">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
                                        <ul class="product__action">
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product-details.html">
                                            <img src="<c:url value='resources/shop/images/product/8.jpg'/>" alt="product images">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
                                        <ul class="product__action">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                        <div class="prize__inner">
                            <div class="prize__thumb">
                                <img src="<c:url value='resources/shop/images/banner/big-img/1.png'/>" alt="banner images">
                            </div>
                    ...
                    <div class="product__wrap clearfix">
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                            <div class="category">
                                <div class="ht__cat__thumb">
                                    <a href="product-details.html">
                                        <img src="<c:url value='resources/shop/images/product/9.jpg'/>" alt="product images">
                                    </a>
                                </div>
                                <div class="fr__hover__info">
                                    <ul class="product__action">
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                            <div class="category">
                                <div class="ht__cat__thumb">
                                    <a href="product-details.html">
                                        <img src="<c:url value='resources/shop/images/product/10.jpg'/>" alt="product images">
                                    </a>
                                </div>
                                <div class="fr__hover__info">
                                    <ul class="product__action">
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                            <div class="category">
                                <div class="ht__cat__thumb">
                                    <a href="product-details.html">
                                        <img src="<c:url value='resources/shop/images/product/11.jpg'/>" alt="product images">
                                    </a>
                                </div>
                                <div class="fr__hover__info">
                                    <ul class="product__action">
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                            <div class="category">
                                <div class="ht__cat__thumb">
                                    <a href="product-details.html">
                                        <img src="<c:url value='resources/shop/images/product/12.jpg'/>" alt="product images">
                                    </a>
                                </div>
                                <div class="fr__hover__info">
                                    <ul class="product__action">
                ...
                <div class="row">
                    <div class="ht__testimonial__activation clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 single__tes">
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="<c:url value='resources/shop/images/test/client/1.png'/>" alt="testimonial images">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 single__tes">
                            <div class="testimonial">
                                <div class="testimonial__thumb">
                                    <img src="<c:url value='resources/shop/images/test/client/2.png'/>" alt="testimonial images">
                                </div>
                                <div class="testimonial__details">
                ...
                <div class="row mt--20">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="htc__best__product">
                            <div class="htc__best__pro__thumb">
                                <a href="product-details.html">
                                    <img src="<c:url value='resources/shop/images/product-2/sm-img-2/1.jpg'/>" alt="small product">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="htc__best__product">
                            <div class="htc__best__pro__thumb">
                                <a href="product-details.html">
                                    <img src="<c:url value='resources/shop/images/product-2/sm-img-2/2.jpg'/>" alt="small product">
                                </a>
                            </div>
                            <div class="htc__best__product__details">
                                <h2><a href="product-details.html">dummy Product title</a></h2>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="htc__best__product">
                            <div class="htc__best__pro__thumb">
                                <a href="product-details.html">
                                    <img src="<c:url value='resources/shop/images/product-2/sm-img-2/3.jpg'/>" alt="small product">
                                </a>
                            </div>
                            <div class="htc__best__product__details">
                                <h2><a href="product-details.html">dummy Product title</a></h2>
                    ...
                    <div class="col-md-12">
                        <div class="ht__brand__inner">
                            <ul class="brand__list owl-carousel clearfix">
                                <li><a href="#"><img src="<c:url value='resources/shop/images/brand/1.png'/>" alt="brand images"></a></li>
                                <li><a href="#"><img src="<c:url value='resources/shop/images/brand/2.png'/>" alt="brand images"></a></li>
                                <li><a href="#"><img src="<c:url value='resources/shop/images/brand/3.png'/>" alt="brand images"></a></li>
                                <li><a href="#"><img src="<c:url value='resources/shop/images/brand/4.png'/>" alt="brand images"></a></li>
                                <li><a href="#"><img src="<c:url value='resources/shop/images/brand/5.png'/>" alt="brand images"></a></li>
                                <li><a href="#"><img src="<c:url value='resources/shop/images/brand/5.png'/>" alt="brand images"></a></li>
                                <li><a href="#"><img src="<c:url value='resources/shop/images/brand/1.png'/>" alt="brand images"></a></li>
                                <li><a href="#"><img src="<c:url value='resources/shop/images/brand/2.png'/>" alt="brand images"></a></li>
                            </ul>
                    ...
                    <div class="ht__blog__wrap clearfix">
                            ...
                            <div class="blog">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="<c:url value='resources/shop/images/blog/blog-img/1.jpg'/>" alt="blog images">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-sm-6 col-xs-12">
                            <div class="blog">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="<c:url value='resources/shop/images/blog/blog-img/2.jpg'/>" alt="blog images">
                                    </a>
                                </div>
                                <div class="blog__details">
                                    <div class="bl__date">
                        ...
                        <div class="col-md-6 col-lg-4 col-sm-6 col-xs-12">
                            <div class="blog">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="<c:url value='resources/shop/images/blog/blog-img/3.jpg'/>" alt="blog images">
                                    </a>
                                </div>
                                <div class="blog__details">
                                    <div class="bl__date">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="copyright__inner">
                                ...
                                <a href="#"><img src="<c:url value='resources/shop/images/others/shape/paypol.png'/>" alt="payment images"></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="<c:url value='resources/shop/js/vendor/jquery-3.2.1.min.js'/>"></script>
